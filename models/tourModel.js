...
const tourSchema = new mongoose.Schema({
    name: {
        ...
        unique: true,
        trim: true,
        maxlength: [40, 'Tour name must have max length of 40 characters.'],
        minlength: [10, 'Tour name must have min length of 10 characters.'],
    ...
    priceDiscount: {
        ...
        validate: {
            ...
            message: 'Discount price ({VALUE}) should be below regulard price.',
        },
    },
    summary: {
        type: String,
