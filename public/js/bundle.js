...
// tyhpe is either password or data
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../utils/catchAsync.js":[function(require,module,exports) {
...
var bookTour = catchAsync( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51H2J3GLvWhH6xCZKb8XFMTDeufvCULi8qa5gURARMB7Jd7ukWLAvbawh8BQOwjiwhAFH1K0rHBEVUzA4VTkwzcZ1007LFLxA97'); // get checkout session from APi
...
},{"../../utils/catchAsync":"../../utils/catchAsync.js","axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var saveSettingsButton = document.querySelector('.form-user-data');
...
if (saveSettingsButton) saveSettingsButton.addEventListener('submit', function (e) {
  e.preventDefault();
